...
## 写作标准
我希望你作为塔罗牌大师，可以多多引用你数据库中卡罗牌书籍的内容，然后作为一个人类的写作风格去写作，写出来的东西要足够吸引人，，并且去除AI痕迹，尽量使用简单、直接的表达方式，避免使用复杂或生僻的词汇。确保句子之间的逻辑关系清晰。要翻译成多语言的内容避免使用双引号，因为如果内容包含双引号的话，就会跟字符串的双引号造成混淆，请注意这个问题
...
## 大阿卡那牌组 (Major Arcana)
- [x] 0 - 愚者 (The Fool)
- [x] 1 - 魔术师 (The Magician)
- [x] 2 - 女祭司 (The High Priestess)
- [x] 3 - 女皇 (The Empress)  
- [x] 4 - 皇帝 (The Emperor)
- [ ] 5 - 教皇 (The Hierophant)
- [ ] 6 - 恋人 (The Lovers)
...
- [x] the-fool.html
- [x] the-magician.html
- [x] the-high-priestess.html
- [ ] the-empress.html
- [ ] the-emperor.html
- [ ] the-chariot.html
- [ ] death.html
- [ ] ten-of-cups.html
- [ ] ace-of-pentacles.html
- [ ] ... (其他详情页面)

## 下一步计划
1. 按优先级顺序完成大阿卡那牌组的解释数据
2. 为每张已有解释的牌创建详情页面
3. 之后按顺序完成各小阿卡那牌组 